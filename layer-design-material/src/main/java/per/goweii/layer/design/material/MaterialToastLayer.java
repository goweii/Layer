...
public class MaterialToastLayer extends ToastLayer {
    ...
    protected View onCreateContent(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        return inflater.inflate(R.layout.layer_design_material_toast, parent, false);
    }
    ...
    @NonNull
    public MaterialToastLayer setMessage(@NonNull CharSequence message) {
        getConfig().mMessage = message;
        return this;
    }

    @NonNull
    public MaterialToastLayer setMessage(int message) {
        getConfig().mMessage = getActivity().getString(message);
        return this;
    }

    @NonNull
    public MaterialToastLayer setIcon(@DrawableRes int icon) {
    ...
    @NonNull
    public MaterialToastLayer setBackgroundResource(@DrawableRes int resource) {
        getConfig().mBackgroundResource = resource;
        return this;
    }

    @NonNull
    public MaterialToastLayer setBackgroundColorInt(@ColorInt int colorInt) {
        getConfig().mBackgroundColor = colorInt;
        return this;
    }

    @NonNull
    public MaterialToastLayer setBackgroundColorRes(@ColorRes int colorRes) {
        getConfig().mBackgroundColor = getActivity().getResources().getColor(colorRes);
        return this;
    }

    @NonNull
    public MaterialToastLayer setTextColorInt(@ColorInt int colorInt) {
        getConfig().mTextColorInt = colorInt;
        return this;
    }

    @NonNull
    public MaterialToastLayer setTextColorRes(@ColorRes int colorRes) {
    ...
    public static class ViewHolder extends ToastLayer.ViewHolder {
        ...
        public ImageView getIcon() {
            return getContent().findViewById(R.id.layer_design_material_toast_content_icon);
        }

        @Nullable
        public TextView getMessage() {
            return getContent().findViewById(R.id.layer_design_material_toast_content_msg);
        }
    }
